...
fig_a1.write_html(f"{OUTPUT_DIR}/05_ttf_distribution.html")
...
fig_a2.write_html(f"{OUTPUT_DIR}/05_agent_adoption_timing.html")
...
fig_a3.write_html(f"{OUTPUT_DIR}/05_active_days_distribution.html")
...
fig_b1.write_html(f"{OUTPUT_DIR}/05_global_funnel.html")
...
fig_b2.write_html(f"{OUTPUT_DIR}/05_cohort_funnel.html")
...
fig_b3.write_html(f"{OUTPUT_DIR}/05_dropoff_analysis.html")
