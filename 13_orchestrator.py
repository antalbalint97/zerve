...
STEPS = [
    ...
    },
    {
        ...
        "emoji"      : "[06]",
        "description": "KPI matrix, B1 teljes + B2 szukitett early signal modell",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[07]",
        "description": "Signup hour hatas + Kaplan-Meier survival szegmens/visszateres/adoptacio szerint",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[08]",
        "description": "India hipotezis validalas + Agent Builder definicio argumentacio",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[09]",
        "description": "Kohorszonkenti parhuzamos RF modell -- Zerve Fleet mintaja",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[10]",
        "description": "Time-to-AB, activation milestone-ok, user eletut utvonalak",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[11]",
        "description": "Tool bigram/trigram workflow fingerprints, session komplexitas novekedes",
        "outputs"    : [
    ...
    },
    {
        ...
        "emoji"      : "[12]",
        "description": "Kredit intenzitas, error assist jel, kauzalis hatas becslese PSM-mel",
        "outputs"    : [
    ...
    },
    {
        ...
        "script"     : "14_canvas_complexity.py",
        "emoji"      : "[CC]",
        "description": "Canvas-level complexity growth and repeat-canvas retention signals",
        "outputs"    : [
            "outputs/14_canvas_complexity_distribution.html",
            "outputs/14_canvas_growth_by_segment.html",
            "outputs/14_repeat_canvas_retention.html",
    ...
    },
    {
        ...
        "script"     : "15_churn_prediction.py",
        "emoji"      : "[CH]",
        "description": "14-day churn model for active users with complexity-enriched features",
        "outputs"    : [
            "outputs/15_churn_roc_pr.html",
            "outputs/15_churn_feature_importance.html",
            "outputs/15_churn_risk_buckets.html",
    ...
    },
    {
        ...
        "script"     : "16_ngram_workflow_analysis.py",
        "emoji"      : "[NG]",
        "description": "Lifecycle and session motif analysis across segments, churn, and complexity",
        "outputs"    : [
            "outputs/16_event_ngram_lift.html",
            "outputs/16_segment_workflow_motifs.html",
            "outputs/16_churn_vs_retained_motifs.html",
    ...
    },
    {
        ...
        "script"     : "17_geo_location_analysis.py",
        "emoji"      : "[GEO]",
        "description": "Country and region level onboarding, churn, and complexity comparisons",
        "outputs"    : [
            "outputs/17_country_segment_mix.html",
            "outputs/17_geo_onboarding_effectiveness.html",
            "outputs/17_geo_churn_complexity_heatmap.html",
    ...
    },
    {
        ...
        "script"     : "18_intervention_scoring.py",
        "emoji"      : "[INT]",
        ...
        "outputs"    : [
            ...
            "outputs/18_intervention_mix.html",
            "outputs/18_intervention_signal_profile.html",
            "outputs/18_top_intervention_candidates.html",
        ],
        "timeout_sec": 300,
    },
    {
        ...
        "script"     : "19_quality_of_struggle.py",
        "emoji"      : "[STR]",
        ...
        "outputs"    : [
            ...
            "outputs/19_quality_of_struggle_mix.html",
            "outputs/19_quality_of_struggle_signals.html",
            "outputs/19_recovery_vs_abandonment.html",
        ],
        "timeout_sec": 300,
    },
    {
        ...
        "script"     : "20_path_branching_model.py",
        "emoji"      : "[PTH]",
        "description": "Quantifies where Ghost, Viewer, and Builder paths diverge in the first few steps",
        "outputs"    : [
            "outputs/20_branch_step_divergence.csv",
            "outputs/20_branching_summary.csv",
            "outputs/20_path_step_mix.html",
            "outputs/20_top_branch_points.html",
            "outputs/20_segment_path_prefixes.html",
        ],
        "timeout_sec": 300,
    },
]
...
def main():
    ...
    with open(LOG_FILE, "w") as log_fh:
        ...
        for step_cfg in steps_to_run:
            ...
            if success:
                print(f"   [OK] Done in {step_status.get('duration_sec', 0):.1f}s")
